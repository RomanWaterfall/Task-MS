...
@WithMockUser(username = "Jopa", password = "dada", authorities = "ROLE_MODERATOR")
public class UserControllerTest extends BaseIntegrationTest {
    ...
    void createControllerTest() throws Exception {
        ...
        UserRequest userRequest = new UserRequest("Pomidorka", "sad@mail.com", "12345", "John", "Doe");
